...
|--------|-----------|-------|
| Examine | Yes | Reviewed stakeholder register, customer security requirements, regulatory tracker |
| Interview | Yes | CISO, General Counsel, VP Sales |
| Test | No | N/A |
...
- Internal stakeholders (Board, engineering, sales) and their cybersecurity expectations are documented
- External stakeholder requirements (customer security questionnaires, SOC 2 expectations) tracked in ServiceNow
- Regulatory obligations mapped to policies and controls

### Gaps

- Stakeholder register not formally updated since Q3 2025
- Partner ecosystem security expectations not yet documented
...
- Customer security questionnaire responses (sample of 10)
