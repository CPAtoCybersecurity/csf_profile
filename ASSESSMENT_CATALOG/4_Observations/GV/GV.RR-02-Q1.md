...
- Risk management roles documented in Information Security Policy with escalation paths
- RACI matrix maintained in ServiceNow mapping all cybersecurity functions
- Performance goals documented for security team tied to organizational KPIs
- Cybersecurity responsibilities included in personnel descriptions for relevant roles

### Gaps

- RACI matrix last reviewed Q3 2025; does not reflect recent team restructuring
- Performance goals for department heads' cybersecurity responsibilities not consistently measured
...
- RACI matrix in ServiceNow
- Security team job descriptions (sample of 8)
- Performance review templates and goals documentation
