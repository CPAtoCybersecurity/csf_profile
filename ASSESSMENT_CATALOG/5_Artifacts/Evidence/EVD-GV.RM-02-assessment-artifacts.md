...
the ServiceNow risk register or GRC tool).
...
| R-03 | Slow Incident Detection (TTD) | Medium | High | SOC Manager | Mitigate (GuardDuty + CloudTrail monitoring) | Q1 2026 | Largely Resolved (TTD 7hrs) |
...
| Treatment Description | Two-track approach: (1) active hiring for 3 open security engineer roles with Q2 2026 target close dates; (2) compensating control via SentinelOne MDR contract covering endpoint detection and 24/7 monitoring while headcount gap persists |
| Compensating Controls | SentinelOne Vigilance MDR; AWS-native alerting (GuardDuty findings via PagerDuty) routed to MDR team outside business hours |
...
HIGHLIGHTS THIS QUARTER:
  ✓ TTD reduced from 81 hours to 12 hours (CloudTrail + GuardDuty implementation)
  ✓ SentinelOne MDR contract signed — 24/7 coverage operational Dec 2025
